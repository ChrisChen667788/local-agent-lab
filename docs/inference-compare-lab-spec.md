...
- 统一 target catalog
  - [catalog.ts](../lib/agent/catalog.ts)
- chat / stream 主链路
  - [route.ts](../app/api/agent/chat/route.ts)
  - [route.ts](../app/api/agent/chat/stream/route.ts)
- replay compare 基础
  - [AgentWorkbench.tsx](../components/agent/AgentWorkbench.tsx)
- benchmark progress / persisted run 思路
  - [benchmark-progress-store.ts](../lib/agent/benchmark-progress-store.ts)
...
- [AgentWorkbench.tsx](../components/agent/AgentWorkbench.tsx)
- [types.ts](../lib/agent/types.ts)
- [providers.ts](../lib/agent/providers.ts)
- [runtime/route.ts](../app/api/agent/runtime/route.ts)
